...
type tAccountRecord struct {}
var AccountRecord tAccountRecord


func (_ tAccountRecord) Save(
		) string {
	args := make(map[string]string)
	
	return revel.MainRouter.Reverse("AccountRecord.Save", args).Url
}

func (_ tAccountRecord) Delete(
		) string {
	args := make(map[string]string)
	
	return revel.MainRouter.Reverse("AccountRecord.Delete", args).Url
}

func (_ tAccountRecord) Update(
		) string {
	args := make(map[string]string)
	
	return revel.MainRouter.Reverse("AccountRecord.Update", args).Url
}

func (_ tAccountRecord) Getall(
		) string {
	args := make(map[string]string)
	
	return revel.MainRouter.Reverse("AccountRecord.Getall", args).Url
}
